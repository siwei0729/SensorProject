...
unsigned long CurrentTime, StartTime, ElapsedTime;
void setup() {
...

{
  ...
  Serial.println(",");
  if (abs(Gxyz[0]) > 1) {
    degX += ElapsedTime * 1.0 / 1000 * Gxyz[0];
  }
  if (abs(Gxyz[1]) > 1) {
    degY += ElapsedTime * 1.0 / 1000 * Gxyz[1];
  }
//  if(abs(Axyz[2]-1)<0.1 ){
//    degX=0;
//    degY=0;
//  }
  Serial.println("Degrees of X,Y,Z:");
  Serial.print(degX);
  Serial.print(",");
  Serial.print(degY);
  Serial.println(",");

  Serial.println("balanced Acc of X,Y,Z:");
  Serial.print(Axyz[0] - getGX());
  Serial.print(",");
  Serial.print(Axyz[1] - getGY());
  Serial.print(",");
  Serial.print(Axyz[2] - getGZ());
  Serial.println(",");
...
void getDist(double aX, double aY, double aZ) {
...
double getGZ() {
  double temp = tan(degY/180*3.14) * tan(degY/180*3.14) + tan(degX/180*3.14) * tan(degX/180*3.14) + 1;
  return sqrt(1 / temp);
}
double getGY() {
  double temp = tan(degY/180*3.14) * tan(degY/180*3.14) + tan(degX/180*3.14) * tan(degX/180*3.14) + 1;
  return sqrt(1 / temp) * tan(degX/180*3.14);
}
double getGX() {
  double temp = tan(degY/180*3.14) * tan(degY/180*3.14) + tan(degX/180*3.14) * tan(degX/180*3.14) + 1;
  return sqrt(1 / temp) * tan(degY/180*3.14);
}
void resetDis() {
  disX = 0;
  disY = 0;
